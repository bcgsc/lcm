 ...
 */
public class ContourMeasurementMapper extends MeasurementMapper{



    final private static Logger logger = LoggerFactory.getLogger(MeasurementMapper.class);

    private ColorMapper colorMapper = new ContourColorMapper();



    public ContourMeasurementMapper(String measurement, Collection<PathObject> pathObjects) {
    ...
    public Integer getColorForObject(PathObject pathObject) {
        ...
        if (super.getExcludeOutsideRange() && value < super.getDisplayMinValue())
            return ColorTools.makeRGB(0,0,255);
        if (super.getExcludeOutsideRange() && value > super.getDisplayMaxValue())
            return ColorTools.makeRGB(255,0,0);
    ...
    public static class ContourColorMapper implements MeasurementMapper.ColorMapper {

        private static final int[] r = {145, 145, 145, 145, 145, 145};
        private static final int[] g = {145, 145, 145, 145, 145, 145};
        private static final int[] b = {145, 145, 145, 145, 145, 145};
